...
function Sidebar({chatOpened, setChatOpened, chatDisplayed, setChatDisplayed, ProjectsRef, SchoolRef, WorkRef, SkillsRef, LangRef, VolRef, RefRef }){
	...
	<div className="sidebar mt-[-25px] sm:mt-[-10px] md:mt-0">
		...
		<div className="sidebar__div mt-2 p-5 pl-8 pr-8" >
			...
			<div>
				{aboutOpen ? 	
				(<p className="mt-2 mb-4 text-sm">As a dedicated and ambitious freshman in college with a passion for the tech industry, ranging from IT to mechanical engineering, I am actively seeking entry-level opportunities to apply my knowledge and skills. <br></br><br></br> Coming from Europe and having completed Harvard's CS50 course, where I gained proficiency in C, Python, HTML, CSS, and Javascript, I possess a strong foundation in computer science. Additionally, my background in Business Intelligence and Technology, coupled with my fluency in five languages - English, Spanish, German, Slovakian and Czech - allows me to be a valuable part of any international team. <br></br><br></br> I am a big sport enthusiast and I dedicate a big part of my daily routine to fitness and soccer. <br></br><br></br> With a diligent work ethic and a keen aptitude for taking on challenges, I am thrilled to make a meaningful impact as a web or software developer and continually expand my horizons in the dynamic world of technology. <br></br><br></br> <span className="">PDF Resumé</span> <a href="https://docs.google.com/document/d/10Z1Rwo3VffT7zg3ANrw2m7ZtKjAAZEi_rnSpo9LPkXw/edit" target="_blank" rel="noopener noreferrer"><span className="font-bold hover:cursor-pointer hover:text-linkedin">here</span></a></p>)
				:
